...
def data_transformations(matrix_list,variables_target,normalized_depths):
    ...
    for matrix in matrix_list:
        ...
        matrix_interpolated_axis1 = pandas_matrix.interpolate(axis=1).replace(0,np.nan)
        matrix_interpolated_axis10 = matrix_interpolated_axis1.interpolate(axis=0).replace(0,np.nan)
        ...
        transform_data[variables_target[count]+transformation_names[0]] = matrix_interpolated_axis1
